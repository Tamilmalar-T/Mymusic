...
import { FiMail, FiLock, FiMusic, FiAlertCircle, FiEye, FiEyeOff } from "react-icons/fi";
...
function Login() {
  ...
  return (
    ...
    >
      {/* Glow Backdrops */}
      <div className="glow-blob" style={{ top: "15%", left: "15%" }}></div>
      <div className="glow-blob-purple" style={{ bottom: "10%", right: "10%" }}></div>
      ...
      >
        <div className="text-center mb-4">
          ...
          <h2 style={{ fontSize: "1.8rem", fontWeight: "800", margin: 0 }}>Welcome Back</h2>
          <p style={{ color: "var(--text-subdued)", fontSize: "0.9rem", marginTop: "6px" }}>
            Login to your premium sound space
          </p>
        </div>
        ...
        <div className="text-center" style={{ fontSize: "0.9rem" }}>
          <span style={{ color: "var(--text-subdued)" }}>New to MyMusic? </span>
